...
th $OPENNMT_HOME/translate.lua -model output/en-de-model_epoch13_10.10_release.t7 -src input/en-de/src-test.txt.tok -output output/en-de-pred13.txt -gpuid 1
